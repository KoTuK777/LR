...
|---|---|---|---|---|---|---|---|
| <span style="color:red">Лінійні алгоритми та програми</span> | Алгоритми та програми розгалуженої структури | Циклічні алгоритми та програми | Типові прийоми програмування | Програмування ітераційних циклічних обчислю-вальних процесів | Одновимірні масиви | Багатовимірні масиви | Методичка та конспекти | Матеріали для виконання лабораторних робіт |
