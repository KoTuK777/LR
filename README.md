...
|---|---|---|---|---|---|---|---|
| Лінійні алгоритми та програми | Алгоритми та програми розгалуженої структури | Циклічні алгоритми та програми | Типові прийоми програмування | Програмування ітераційних циклічних обчислю-вальних процесів | Одновимірні масиви | Багатовимірні масиви | Матеріали для виконання лабораторних робіт |


## Як запустити програму
1. Запустити текстовий файл в Dev C++ або Visual Studio
![screenshot](https://i.ibb.co/YLrfZb1/screenshot.png)
2. Скомпілювати та запустити програму
![screenshot](https://i.ibb.co/pPxqvPT/screenshot1.png)
